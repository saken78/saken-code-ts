...
/**
 * React Best Practices Agent - Specialized for React and Next.js performance optimization
 */
export const reactBestPractise: SubagentConfig = {
  name: 'react-best-practise',
  description:
...
`,
  ...
  capabilities: [
    ...
    'server_side_performance',
    'javascript_performance',
    'react_component_refactoring',
    'nextjs_optimization',
  ],
  triggerKeywords: [
    'react optimization',
